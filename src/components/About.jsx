      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-6">
            ...
            crafting engaging, accessible, and performant web interfaces. Based
            in India, I’ve spent the last year turning UI challenges into
            seamless experiences.
          </p>

          <p className="text-md text-gray-400 mb-6">
            Whether it’s React, Tailwind, or APIs—I love working on products
            that bring real value to users. Always curious, constantly learning,
            and building with care.
          </p>
