  ...
  return (
    <footer className="bg-gray-900 text-cyan-300 px-6 py-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 text-center md:text-left">
        <div>
          <h2 className="text-lg font-semibold">{FOOTER.COPYRIGHT_NAME}</h2>
          <p className="text-sm">&copy; {FOOTER.COPYRIGHT_TEXT}</p>
        </div>

        <div>
          <h3 className="font-semibold mb-2">{FOOTER.CONNECT_TEXT}</h3>
